...
if __name__ == '__main__':
  ...
  parser.add_argument('--H', type=int, default=620,
      help='Input image height (default: 120).')
  parser.add_argument('--W', type=int, default=620,
  ...
  # aibo
  for imagee in os.listdir(opt.input):
    # read image
    img_path = os.path.join(opt.input,imagee)
    ...
    pts, desc, heatmap = fe.run(img_float32)


    # save the keypoints
    np.savetxt(os.path.join(opt.write_dir,imagee.replace('png','txt')), pts)
    print(imagee.replace('png','txt'))
  print('==> Finshed Demo.')
  exit()
