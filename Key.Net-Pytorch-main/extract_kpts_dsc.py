...
if __name__ == '__main__':
    ...
    parser.add_argument('--list-images', type=str, default='image_list.txt',help='File containing the image paths for extracting features.')

    parser.add_argument('--root-images', type=str, default='dataset/',
    ...
    for idx_im in tqdm(range(len(lines))):
        ...
        result_path = os.path.join(args.results_dir, tmp_line)
